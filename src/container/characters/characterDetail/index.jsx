  ...
  const CharacterDetail = ({characterid}) => {
    ...
    return (
      ...
      <div id="dropdowns" style={{ display: 'flex', justifyContent: 'center', borderRadius: '10px', margin: '20px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.3)' }}>
          <div id="dropdowns" style={{ display: 'grid', borderRadius: '10px', margin: '20px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.3)' }}>
      <a style={uniqueOutfits.some(item => item.trim().toLowerCase() === 'headset') ? { height:'120px', margin: '20px', fontSize: '20px', textAlign: 'center', padding: '20px', background: 'linear-gradient(to bottom, #606060, #808080)', opacity: 0.8, borderRadius: '5px', border: '1px solid #ccc', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', color: '#fff' } : {display: 'none'}}>
           ...
           <a style={uniqueOutfits.some(item => item.trim().toLowerCase() === 'shirts') ? { height:'120px',margin: '20px', fontSize: '20px', textAlign: 'center', padding: '20px', background: 'linear-gradient(to bottom, #606060, #808080)', opacity: 0.8, borderRadius: '5px', border: '1px solid #ccc', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', color: '#fff' } : {display: 'none'}}>
      ...
      <Canvas onClick={handleCanvasClick} style={{ width: '90%', height: '600px', maxWidth: '800px', margin: '20px auto' }}>
        <mesh>
      ...
      <div id="dropdowns" style={{ display: 'grid', borderRadius: '10px', margin: '20px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.3)' }}>
       <a style={uniqueOutfits.some(item => item.trim().toLowerCase() === 'vest') ? {height:'120px', margin: '20px', fontSize: '20px', textAlign: 'center', padding: '20px', background: 'linear-gradient(to bottom, #606060, #808080)', opacity: 0.8, borderRadius: '5px', border: '1px solid #ccc', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', color: '#fff' } : {display: 'none'}}>
              <label style={{  margin:'20px', padding: '20px', fontWeight: 'bold' }} htmlFor="selectDropdown1">Vest</label>
              <br></br><hr></hr>
              <select id="selectDropdown3" onChange={(e) => setselectedVest(e.target.value)} style={{ background: 'rgba(128, 128, 128, 0.5)', border: 'none', padding: '5px 10px', borderRadius: '5px', color: '#fff' }}>
                  <option>None</option>
                  {outfitData?.Vest?.map(option => (
                      <option key={option.id} value={option.value}>{option.name}</option>
                  ))}
              </select>
          </a>
           <a style={uniqueOutfits.some(item => item.trim().toLowerCase() === 'backpack') ? {height:'120px', margin: '20px', fontSize: '20px', textAlign: 'center', padding: '20px', background: 'linear-gradient(to bottom, #606060, #808080)', opacity: 0.8, borderRadius: '5px', border: '1px solid #ccc', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', color: '#fff' } : {display: 'none'}}>
     ...
     <div id="dropdowns" style={{ display: 'flex', justifyContent: 'center', borderRadius: '10px', margin: '20px', boxShadow: '0 0 20px rgba(0, 0, 0, 0.3)' }}>
          ...
          <a style={uniqueOutfits.some(item => item.trim().toLowerCase() === 'extras') ? { margin: '20px', fontSize: '20px', textAlign: 'center', padding: '20px', background: 'linear-gradient(to bottom, #606060, #808080)', opacity: 0.8, borderRadius: '5px', border: '1px solid #ccc', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', color: '#fff' } : {display: 'none'}}>
              ...
              <br></br><hr></hr>
              <select id="selectDropdown3" onChange={(e) => setselectedExtras(e.target.value)} style={{ width:'252px',background: 'rgba(128, 128, 128, 0.5)', border: 'none', padding: '5px 10px', borderRadius: '5px', color: '#fff' }}>
                  <option>None</option>
